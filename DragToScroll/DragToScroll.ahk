...
ApplySettings:
  ...
  Setting("Button", "F12 & LButton") ;<-- Scroll
  ...
  Setting("UseAccelerationY", false)
  ...
  Setting("MomentumInertia", .85) ; (0 < VALUE < 1) Describes how fast the scroll momentum dampens
  ...
  Setting("GestureBrowserNames", "vivaldi.exe,chrome.exe,firefox.exe,iexplore.exe")
  ...
  Setting("ChangedCursorStyle", "cursorHand")
